...
This is a **breaking change** for any user scripts, CI jobs, shell aliases, shell completions, or documentation that invoke `waif`.
...
- Align CLI naming with the project’s "WF" naming in docs and workflows.
